#!/usr/bin/env python3
"""office-kit GUI — visual updater for office."""
...
class GUI:
 def __init__(self):
 self.root = tk.Tk()
 self.root.title("office-kit")
 self.root.geometry("500x400")
 self.root.resizable(False, False)

 # Header
 ttk.Label(self.root, text="office-kit", font=("Arial", 16, "bold")).pack(pady=10)
 ttk.Label(self.root, text="Office Configuration Tool").pack()
